    ...
    <div class="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
        <transition-group name="toast">
            <div
                  ...
                  :key="toast.id"
                  :class="[
                    'max-w-sm px-4 py-3 rounded-lg shadow-md transform transition-all duration-300 ease-in-out',
                    {
                    ...
                    { 'translate-y-0 opacity-100': toast.show, 'translate-y-2 opacity-0': !toast.show }
                ]"
                  role="alert"
            >
